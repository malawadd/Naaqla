...
defineNewRecord = async (batchNumber,DateOfCollecting,Location,milkQuantityAccepted,QualityDetails,VehicleDetails,IOC) =>{
    const RecordHistory =  Moralis.Object.extend('Record');
    const record = new RecordHistory();
    record.set('batchNumber', batchNumber);
    record.set('DateOfCollecting', DateOfCollecting);
    record.set('Location', Location);
    record.set('milkQuantityAccepted', milkQuantityAccepted);
    record.set('QualityDetails', QualityDetails);
    record.set('VehicleDetails', VehicleDetails);
    record.set('IOC', IOC);

    const metadata = {
        batchNumber: batchNumber,
        DateOfCollecting: DateOfCollecting,
        Location: Location,
        milkQuantityAccepted: milkQuantityAccepted,
...
async function submit(){
    ...
    document.querySelector('#input_Location').value,
     ...
     document.querySelector('#input_QualityDetails').value,
     document.querySelector('#input_VechicleDetails').value,
     document.querySelector('#input_IdentityOFCollector').value,
    )
