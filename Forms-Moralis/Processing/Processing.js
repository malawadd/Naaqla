...
defineNewRecord = async (batchNumber,DT,ProductTesting,Location,QualityFactors) =>{
...
async function submit(){
    ...
    document.querySelector('#input_ProccessingDetails').value,
    document.querySelector('#input_DT').value,
     document.querySelector('#input_ProductTesting').value,
     document.querySelector('#input_Location').value,
     document.querySelector('#input_QualityFactors').value,
    )
