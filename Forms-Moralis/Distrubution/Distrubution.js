...
defineNewRecord = async (batchNumber,ShipmentNumber,Volume,IOR,OrderNumber,CargoStatus,DT) =>{
    const RecordHistory =  Moralis.Object.extend('Record');
    const record = new RecordHistory();
    record.set('batchNumber', batchNumber);
    record.set('ShipmentNumber', ShipmentNumber);
    record.set('Volume', Volume);
    record.set('IOR', IOR);
    record.set('OrderNumber', OrderNumber);
    record.set('CargoStatus', CargoStatus);
    record.set('DT', DT);
...
async function submit(){
    ...
    document.querySelector('#input_Shipment_Number').value,
    document.querySelector('#input_Volume').value,
     document.querySelector('#input_IOR').value,
     document.querySelector('#input_OrderNumber').value,
     document.querySelector('#input_CargoStatus').value,
